package io.zero88.qwe.gradle.app

import io.zero88.qwe.gradle.QWEDecoratorPlugin
import io.zero88.qwe.gradle.app.task.ConfigGeneratorTask
import io.zero88.qwe.gradle.app.task.LoggingGeneratorTask
import io.zero88.qwe.gradle.app.task.SystemdServiceGeneratorTask
...
class QWEAppPlugin : QWEDecoratorPlugin<QWEAppExtension> {
    ...
    override fun applyExternalPlugins(project: Project) {
        project.plugins.apply(io.zero88.qwe.gradle.QWEOSSProjectPlugin::class.java)
    }

    override fun configureExtension(project: Project, qweExt: io.zero88.qwe.gradle.QWEExtension): QWEAppExtension {
    ...
    override fun registerAndConfigureTask(
        project: Project,
        qweExt: io.zero88.qwe.gradle.QWEExtension,
