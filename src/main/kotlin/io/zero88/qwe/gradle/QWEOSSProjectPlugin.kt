...
import io.zero88.qwe.gradle.helper.computeBaseName
...
class QWEOSSProjectPlugin : Plugin<Project> {
    ...
    private fun evaluateProject(project: Project): io.zero88.qwe.gradle.QWEExtension {
        val qweExt =
            project.extensions.create<io.zero88.qwe.gradle.QWEExtension>(io.zero88.qwe.gradle.QWEExtension.Companion.NAME)
        ...
        project.afterEvaluate {
            ...
            if (qweExt.zero88.get()) {
                qweExt.publishingInfo.developer {
                    id.set(io.zero88.qwe.gradle.QWEExtension.Companion.DEV_ID)
                    email.set(io.zero88.qwe.gradle.QWEExtension.Companion.DEV_EMAIL)
                }
            }
    ...
    private fun configureExtension(project: Project, qweExt: io.zero88.qwe.gradle.QWEExtension) {
    ...
    private fun TaskContainerScope.configExternalTasks(project: Project, qwe: io.zero88.qwe.gradle.QWEExtension) {
    ...
    private fun computeMavenRepositoryUrl(project: Project, qwe: io.zero88.qwe.gradle.QWEExtension): URI {
