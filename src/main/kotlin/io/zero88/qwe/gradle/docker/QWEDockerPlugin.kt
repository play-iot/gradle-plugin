package io.zero88.qwe.gradle.docker

import com.bmuschko.gradle.docker.DockerExtension
import com.bmuschko.gradle.docker.DockerRemoteApiPlugin
import com.bmuschko.gradle.docker.tasks.image.DockerBuildImage
import com.bmuschko.gradle.docker.tasks.image.Dockerfile
import io.zero88.qwe.gradle.QWEDecoratorPlugin
import io.zero88.qwe.gradle.QWEExtension
import io.zero88.qwe.gradle.app.QWEAppPlugin
import io.zero88.qwe.gradle.docker.task.DockerMultipleRegistriesPushTask
import io.zero88.qwe.gradle.helper.prop
...
@Suppress("UnstableApiUsage") class QWEDockerPlugin : io.zero88.qwe.gradle.QWEDecoratorPlugin<QWEDockerExtension> {
    ...
    override fun configureExtension(project: Project, qweExt: io.zero88.qwe.gradle.QWEExtension): QWEDockerExtension {
        ...
        project.afterEvaluate {
            ...
            if (qweExt.zero88.get()) {
                ext.maintainer.set("${io.zero88.qwe.gradle.QWEExtension.DEV_ID} <${io.zero88.qwe.gradle.QWEExtension.DEV_EMAIL}>")
            }
    ...
    override fun registerAndConfigureTask(project: Project, qweExt: io.zero88.qwe.gradle.QWEExtension, decoratorExt: QWEDockerExtension) {
